...
h?(a.line++,a.column=1,a.seenCR=!0):(a.column++,a.seenCR=!1)}a.offset+=b}function g(a){b.offset<v.offset||(b.offset>v.offset&&(v=c(b),y=[]),y.push(a))}function s(){var a,f,e,d;d=c(b);a=z();null!==a?(f=A(),null!==f?(e=s(),null!==e?a=[a,f,e]:(a=null,b=c(d))):(a=null,b=c(d))):(a=null,b=c(d));null===a&&(a=z());return a}function z(){var a,f,e,d,h;d=c(b);h=c(b);a=w();null!==a?(f=q(),null!==f?(e=p(),null!==e?a=[a,f,e]:(a=null,b=c(h))):(a=null,b=c(h))):(a=null,b=c(h));null!==a&&(a={x:a[0],mode:a[1],min:a[2].min,
...
f?(e=t(),null!==e?a=[a,f,e]:(a=null,b=c(h))):(a=null,b=c(h))):(a=null,b=c(h)),null!==a&&(a="/"),null===a&&(b=c(k))));return a}function t(){var a,c;a=[];/^[ ]/.test(d.charAt(b.offset))?(c=d.charAt(b.offset),l(b,1)):(c=null,0===m&&g("[ ]"));for(;null!==c;)a.push(c),/^[ ]/.test(d.charAt(b.offset))?(c=d.charAt(b.offset),l(b,1)):(c=null,0===m&&g("[ ]"));return a}function w(){var a,f,e,k;e=c(b);a=B();null!==a&&(a=function(a,b,c,e){a=function(){return e};a.static=!0;return a}(e.offset,e.line,e.column,a));
null===a&&(b=c(e));null===a&&(e=c(b),a=x(),null!==a&&(a=function(a,b,c,e){a=function(a){return a[e]};a.static=!1;a.variable=e;a.operation="none";return a}(e.offset,e.line,e.column,a)),null===a&&(b=c(e)),null===a&&(e=c(b),k=c(b),102===d.charCodeAt(b.offset)?(a="f",l(b,1)):(a=null,0===m&&g('"f"')),null!==a?(f=x(),null!==f?a=[a,f]:(a=null,b=c(k))):(a=null,b=c(k)),null!==a&&(a=function(a,b,c,e){a=function(a){return Math.floor(a[e])};a.static=!1;a.variable=e;a.operation="floor";return a}(e.offset,e.line,
e.column,a[1])),null===a&&(b=c(e)),null===a&&(e=c(b),k=c(b),114===d.charCodeAt(b.offset)?(a="r",l(b,1)):(a=null,0===m&&g('"r"')),null!==a?(f=x(),null!==f?a=[a,f]:(a=null,b=c(k))):(a=null,b=c(k)),null!==a&&(a=function(a,b,c,e){a=function(a){return Math.round(a[e])};a.static=!1;a.variable=e;a.operation="round";return a}(e.offset,e.line,e.column,a[1])),null===a&&(b=c(e)))));return a}function x(){var a,f,e,k,h;k=c(b);h=c(b);91===d.charCodeAt(b.offset)?(a="[",l(b,1)):(a=null,0===m&&g('"["'));if(null!==
a){/^[a-zA-Z 0-9]/.test(d.charAt(b.offset))?(e=d.charAt(b.offset),l(b,1)):(e=null,0===m&&g("[a-zA-Z 0-9]"));if(null!==e)for(f=[];null!==e;)f.push(e),/^[a-zA-Z 0-9]/.test(d.charAt(b.offset))?(e=d.charAt(b.offset),l(b,1)):(e=null,0===m&&g("[a-zA-Z 0-9]"));else f=null;null!==f?(93===d.charCodeAt(b.offset)?(e="]",l(b,1)):(e=null,0===m&&g('"]"')),null!==e?a=[a,f,e]:(a=null,b=c(h))):(a=null,b=c(h))}else a=null,b=c(h);null!==a&&(a=a[1].join(""));null===a&&(b=c(k));return a}function B(){var a,f,e,k,h;m++;
k=c(b);/^[0-9]/.test(d.charAt(b.offset))?(f=d.charAt(b.offset),l(b,1)):(f=null,0===m&&g("[0-9]"));if(null!==f)for(a=[];null!==f;)a.push(f),/^[0-9]/.test(d.charAt(b.offset))?(f=d.charAt(b.offset),l(b,1)):(f=null,0===m&&g("[0-9]"));else a=null;null!==a&&(a=parseInt(a.join(""),10));null===a&&(b=c(k));if(null===a){k=c(b);h=c(b);45===d.charCodeAt(b.offset)?(a="-",l(b,1)):(a=null,0===m&&g('"-"'));if(null!==a){/^[0-9]/.test(d.charAt(b.offset))?(e=d.charAt(b.offset),l(b,1)):(e=null,0===m&&g("[0-9]"));if(null!==
e)for(f=[];null!==e;)f.push(e),/^[0-9]/.test(d.charAt(b.offset))?(e=d.charAt(b.offset),l(b,1)):(e=null,0===m&&g("[0-9]"));else f=null;null!==f?a=[a,f]:(a=null,b=c(h))}else a=null,b=c(h);null!==a&&(a=-1*parseInt(a[1].join(""),10));null===a&&(b=c(k))}m--;0===m&&null===a&&g("integer");return a}function D(a){a.sort();for(var b=null,c=[],d=0;d<a.length;d++)a[d]!==b&&(c.push(a[d]),b=a[d]);return c}var r={dicerolls:s,diceroll:z,rollmode:q,minmax:p,operation:A,ws:t,intval:w,variable:x,integer:B};if(void 0!==
n){if(void 0===r[n])throw Error("Invalid rule name: "+u(n)+".");}else n="dicerolls";var b={offset:0,line:1,column:1,seenCR:!1},m=0,v={offset:0,line:1,column:1,seenCR:!1},y=[],r=r[n]();if(null===r||b.offset!==d.length){var r=Math.max(b.offset,v.offset),E=r<d.length?d.charAt(r):null,C=b.offset>v.offset?b:v;throw new this.SyntaxError(D(y),E,r,C.line,C.column);}return r},toSource:function(){return this._source},SyntaxError:function(d,n,c,l,g){this.name="SyntaxError";this.expected=d;this.found=n;switch(d.length){case 0:d=
"end of input";break;case 1:d=d[0];break;default:d=d.slice(0,d.length-1).join(", ")+" or "+d[d.length-1]}n=n?u(n):"end of input";this.message="Expected "+d+" but "+n+" found.";this.offset=c;this.line=l;this.column=g}};p.SyntaxError.prototype=Error.prototype;return p}();
